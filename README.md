...
[![codecov](https://codecov.io/gh/miacalegari/FastAPI-Project/branch/main/graph/badge.svg?token=FastAPI-Project_token_here)](https://codecov.io/gh/miacalegari/FastAPI-Project)
[![CI](https://github.com/miacalegari/FastAPI-Project/actions/workflows/main.yml/badge.svg)](https://github.com/miacalegari/FastAPI-Project/actions/workflows/main.yml)

Awesome fastapi_project created by miacalegari

## Install

from source
```bash
git clone https://github.com/miacalegari/FastAPI-Project fastapi_project
cd fastapi_project
make install
```
