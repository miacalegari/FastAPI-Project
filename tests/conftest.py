...
# WARNING: Ensure imports from `fastapi_project` comes after this line
from fastapi_project import app, settings, db  # noqa
from fastapi_project.cli import create_user, cli  # noqa
